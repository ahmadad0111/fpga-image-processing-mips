module Reg_FILE_MIN(clk,we1,addr1_1,addr2_1,Din1_1,Din2_1,Dout1_1,Dout2_1,OUTPUT_MIN,IN_addr1,IN_addr2,IN_addr3,IN_data1,IN_data2,IN_data3,reg_we);
...
assign OUTPUT_MIN=REG_FILE[4'd8];
endmodule 